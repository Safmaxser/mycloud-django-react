        ...
        migrations.CreateModel(
            ...
            fields=[
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                code='invalid_format',
                                message='Логин должен быть от 4 до 20 символов, начинаться с буквы и содержать только латиницу и цифры.',
                ...
                (
                    'storage_path',
                    models.CharField(
                        blank=True, max_length=500, verbose_name='Путь к хранилищу'
                    ),
                ),
                (
                    'email',
